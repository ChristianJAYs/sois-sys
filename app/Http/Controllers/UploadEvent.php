...
class UploadEvent extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboards.org.cs.president.upload',compact('eventlist','eventid'))->with('i', (request()->input('page', 1) - 1) * 5);
    ...
    public function show(Events $events)
    {
        ...
        return view('dashboards.org.cs.president.show',compact('events'));
    }
    ...
    public function edit(Events $events)
    {
        ...
        // print_r($data);
        // dd($data);
        $eventid = DB::table('events')->select('user_id')->get();
        // dd($eventid);
