...
class VicePresidentController extends Controller
{
    ...
    {
        return view('dashboards.org.cs.vice_president.cs_index');
    }
    public function profile()
    {
        return view('dashboards.org.cs.vice_president.profile');
    }
    public function functions()
    {
        return view('dashboards.org.cs.vice_president.functions');
    }
    public function listofevents()
    {
        ...
        // dd($eventstatus);
        return view('dashboards.org.cs.vice_president.listofevents',compact('eventlist','eventid','eventstatus'))->with('i', (request()->input('page', 1) - 1) * 5);
        
        // return view('dashboards.org.cs.vice_president.messages');
    }
    public function settings()
    {
        return view('dashboards.org.cs.vice_president.cs_settings');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('upload')->with('success','Event has been created');  
    }
    ...
    public function show(Events $events)
    {
        ...
        // return view('dashboards.org.cs.president.upload',compact('event'));
        // return view('dashboards.org.cs.president.upload',compact('eventlist'));
        return view('dashboards.org.cs.vice_president.show',compact('eventlist','eventid'))->with('i', (request()->input('page', 1) - 1) * 5);
